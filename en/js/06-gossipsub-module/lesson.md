...
- Creating a multi-node demonstration (NODE1 and NODE2)
...
console.log(`[${nodeName}] Subscribed to topic: ${TOPIC}`)
```
...
console.log(`[${nodeName}] Message published successfully`)
```
...
When you run the application, you should see a multi-node demonstration:

```
Starting GossipSub Universal Connectivity Lesson...
Demonstrating coordinated multi-peer GossipSub messaging...

=== NODE 1 SETUP (Bootstrap Peer) ===
[NODE1] Started with Peer ID: 12D3KooW...
[NODE1] Listening on: /ip4/127.0.0.1/tcp/...
[NODE1] Listening on: /ip4/192.168.0.16/tcp/...
[NODE1] Subscribed to topic: universal-connectivity
[NODE1] Ready to accept connections at: /ip4/192.168.0.16/tcp/.../p2p/12D3KooW...

=== NODE 2 SETUP (Connecting Peer) ===
[NODE2] Started with Peer ID: 12D3KooW...
[NODE2] Listening on: /ip4/127.0.0.1/tcp/...
[NODE2] Subscribed to topic: universal-connectivity

=== PEER CONNECTION ESTABLISHMENT ===
[NODE2] Successfully connected to NODE1

=== GOSSIPSUB MESH FORMATION ===
[NODE1] Peer ... subscribed to topic: universal-connectivity
[NODE2] Peer ... subscribed to topic: universal-connectivity
[NODE1] Sees 1 peer(s) subscribed to topic "universal-connectivity"
[NODE2] Sees 1 peer(s) subscribed to topic "universal-connectivity"

=== COORDINATED MESSAGE EXCHANGE ===
[NODE1] Publishing message to topic "universal-connectivity": "..."
[NODE2] Received message from 12D3KooW...: "..." on topic universal-connectivity
[NODE2] Publishing response message to topic "universal-connectivity": "..."
[NODE1] Received message from 12D3KooW...: "..." on topic universal-connectivity

=== GOSSIPSUB DEMONSTRATION SUMMARY ===
Multi-peer GossipSub coordination completed successfully!
✓ NODE1: Started, listened, subscribed, published, and received messages
✓ NODE2: Started, listened, subscribed, connected, published, and received messages
✓ Established peer-to-peer connection between nodes
✓ Formed GossipSub mesh topology with topic subscribers
✓ Coordinated bidirectional message exchange
```
...
- [js-libp2p-gossipsub Documentation](https://github.com/libp2p/js-libp2p/tree/main/packages/pubsub-gossipsub)
