...
async function createNode() {
  // Load peer ID from JSON file (generated by generate_peer_id.js)
  const peerIdJson = JSON.parse(fs.readFileSync("./peer-id.json", "utf8"));

  // Convert the JSON object back to Uint8Array
  const privateKeyBytes = new Uint8Array(Object.values(peerIdJson.privateKey));

  // Recreate the private key from the raw bytes
